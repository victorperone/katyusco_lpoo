...
public class JogoDaVelha extends javax.swing.JFrame {
    ...
    public void Vencedor(String JogadorVencedor){
        ...
        if (JogadorVencedor.equals("Empate")){
            JOptionPane.showMessageDialog(JogoDaVelha.this, "Jogo Empatou");
            //Incrementa o numero de empates
            PrtidasEmpatadas++;
            //Atualiza o numero de empates na interface grafica
            NumeroDeEmpates.setText("Número de Vitórias: " + 
                    PrtidasEmpatadas);
            LimparCampos();
        }
    ...
    private void initComponents() {
        ...
        B3.getAccessibleContext().setAccessibleName("");
    ...
    private void SobreOJogoActionPerformed(java.awt.event.ActionEvent evt) {                                           
